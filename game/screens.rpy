...
screen main_menu():
    ...
    imagemap:
        ...
        idle "images/mainmenu_normal.png"
        hover "images/mainmenu_hooked.png"

        hotspot(500, 488, 902, 87) action Start()
        hotspot(375, 596, 87, 87) action ShowMenu("preferences")
        hotspot(500, 592, 902, 87) action Quit(confirm = True)
